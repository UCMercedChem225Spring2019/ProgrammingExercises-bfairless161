      Program pgrm_01_03
!
!     This program reads two 3x3 matrices from a user-provided input
!     files. After the files are opened and read, they are closed and the matrices
!     printed. Finally, the matrix product of these two matrices is formed
!     using the f90 intrinsic function MatMul. This final matrix is also printed.
!
!     H. P. Hratchian, 2019.
!
      implicit none
...
!
!      data file and read matrixInB from that file.
!
...
!Form matrixProduct using the intrinsic function MatMul. Then, print the result.
